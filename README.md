...
[![ci-status](https://github.com/backslash-f/cskscene/workflows/CI/badge.svg)](https://github.com/backslash-f/cskscene/actions?query=workflow%3ACI)
...
# CSKScene
A **custom** [`SKScene`](https://developer.apple.com/documentation/spritekit/skscene) subclass with debug options enabled by default and the ability to observe game controllers via [`GCOverseer`](https://github.com/backslash-f/gcoverseer).
