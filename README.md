...
# CSKScene
**Custom** [`SKScene`]() subclass with debug options enabled by default and an instance of [`GCOverseer`](https://github.com/backslash-f/gcoverseer).
